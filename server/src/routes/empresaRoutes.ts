...
class TucRoutes{
    ...
    config():void{
         ...
         this.router.get('/api/empresa/:id_empresa',empresaController.ObtenerEmpresa)
         this.router.get('/api/empresa/detalle/:id_empresa',empresaController.ObtenerEmpresaDetalle)
