...
class TucRoutes{
    ...
    config():void{
        ...
        this.router.put('/api/vehiculo/modificar/tuc', vehiculoController.ModificarTucVehiculoAsociado)
        this.router.get('/api/vehiculo/baja/:id_vehiculo', vehiculoController.DarBajaVehiculo)
    }   
}
